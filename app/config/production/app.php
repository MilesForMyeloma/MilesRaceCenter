...
return array(
    ...
    */
    ...
    'payment' => array(
        ...
        'stripe' => array(
            'apikey' => $_SERVER['STRIPE_APIKEY'],
        ),

        'paypalexpress' => array(
            'apiusername' => $_SERVER['PAYPALEXPRESS_USERNAME'],
            'apipassword' => $_SERVER['PAYPALEXPRESS_PASSWORD'],
            'apisignature' => $_SERVER['PAYPALEXPRESS_SIGNATURE'],
        ),
